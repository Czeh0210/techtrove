...
const HeroSection = React.forwardRef(
  (
    ...
    return (
      <div className={cn("relative overflow-hidden w-full h-full", className)} ref={ref} {...props}>
        ...
        <section className="relative w-full h-full mx-auto z-1 flex items-center justify-center">
          <RetroGrid {...gridOptions} />
          <div className="w-full z-10 px-4 md:px-8">
