...
export default function CardStack() {
  ...
  return (
    <div
      className={`w-full h-screen flex items-center justify-center ${currentTheme.bg} transition-all duration-500 relative overflow-hidden`}>
      ...
      {/* Top Control Bar */}
      <div
        className="absolute top-8 left-8 right-8 flex items-center justify-between z-30">
      ...
      {/* Info Text */}
      <div
        className={`absolute bottom-8 left-8 right-8 text-center px-6 py-4 rounded-xl border ${currentTheme.infoBox} backdrop-blur-md transition-all duration-300 z-20 shadow-lg`}>
